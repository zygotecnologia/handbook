...
<span id='Autolinker-property-htmlCharacterEntitiesRegex'>	/**
</span>	 * @private
...
<span id='Autolinker-property-matcherRegex'>	/**
</span>	 * @private
...
<span id='Autolinker-property-charBeforeProtocolRelMatchRegex'>	/**
</span>	 * @private
...
<span id='Autolinker-property-matchValidator'>	/**
</span>	 * @private
...
</span>	 * Automatically links URLs, email addresses, and Twitter handles found in the given chunk of HTML. 
...
<span id='Autolinker-method-processTextNode'>	/**
</span>	 * Process the text that lies inbetween HTML tags. This method does the actual wrapping of URLs with
	 * anchor tags.
	 * 
	 * @private
...
<span id='Autolinker-method-processCandidateMatch'>	/**
</span>	 * Processes a candidate match from the {@link #matcherRegex}. 
	 * 
...
<span id='Autolinker-method-matchHasUnbalancedClosingParen'>	/**
</span>	 * Determines if a match found has an unmatched closing parenthesis. If so, this parenthesis will be removed
...
</span>	 * Creates the return string value for a given match in the input string, for the {@link #processTextNode} method.
	 * 
